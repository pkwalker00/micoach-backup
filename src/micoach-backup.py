...
class BackupWindow(Gtk.Window):
    ...
    def backup_workouts(self, selection, increment):
        for workout in selection:
            ...
            yield True
            if self.xml:
                save_to_folder = self.folder + "/"  + self.user.screenname + "/xml/" + year + "/" + month
                ...
                yield True
            if self.gpx:
                save_to_folder = self.folder + "/"  + self.user.screenname + "/gpx/" + year + "/" + month
                if not os.path.exists(save_to_folder):
                    try:
                        os.makedirs(save_to_folder)
                    except:
                ...
                yield True
            if self.tcx:
                save_to_folder = self.folder + "/"  + self.user.screenname + "/tcx/" + year + "/" + month
                if not os.path.exists(save_to_folder):
                    try:
                        os.makedirs(save_to_folder)
                    except:
